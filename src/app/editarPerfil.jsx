...
import { ActivityIndicator, Text, TextInput, TouchableOpacity, StyleSheet, View, ScrollView } from 'react-native';
...
export default function EditarPerfil() {
  ...
  useEffect(() => {
    const fetchUsuario = async () => {
      try {
        const res = await fetch(`https://683fa1935b39a8039a552628.mockapi.io/api/v1/users/${user?.id}`)
